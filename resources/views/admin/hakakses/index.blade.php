...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master Data /</span> Hak Akses</h4>

      <div class="row p-3">
        <!-- Form controls -->
        <div class="card">
            <h5 class="card-header">Hak Akses &nbsp;  <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-hover">
                ...
                @foreach ($data as $item)
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $item->nama_hakakses }}</strong></td>
                    <td>
                        <a href="{{ url('admin/hakakses/modul_akses/' . Crypt::encrypt($item->hakakses_id)) }}"
                            class="btn text-white btn-primary">Modul</a>
                        <a onclick="return edit({{ $item->hakakses_id }})"
                            class="btn text-white btn-info">Ubah</a>
                        <a href="{{ url('admin/hakakses/delete/' . Crypt::encrypt($item->hakakses_id)) }}"
